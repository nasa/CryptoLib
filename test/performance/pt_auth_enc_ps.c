...
void Write_To_File(uint16_t enc_frame_len, float total_time, char *test_name, int num_frames, int reset)
{
    ...
    {
        if (reset == 1)
            fprintf(fp, "Name of Test,Frames Sent,Bytes per Frame,Total Time,Mbps\n");
        fprintf(fp, "%s,%d,%d,%f,%f\n", test_name, num_frames, enc_frame_len, total_time,
                (((enc_frame_len * 8 * num_frames) / total_time) / 1024 / 1024));
    }
    fclose(fp);
}
...
>>>>>>> origin/dev
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h = "202C047F00000A00000000000000000000006367CCB04793EECE4ECFAE6926856AB15F27C747E4F00F0314AC3174263FCC8"
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security SHORT", num_frames_100,
                  1);
...
UTEST(PERFORMANCE, MDB_LIBG_SHORT_100)
{
    Crypto_Config_CryptoLib(KEY_TYPE_INTERNAL, MC_TYPE_INTERNAL, SA_TYPE_MARIADB, CRYPTOGRAPHY_TYPE_LIBGCRYPT,
                            ...
                            TC_IGNORE_SA_STATE_FALSE, TC_IGNORE_ANTI_REPLAY_TRUE, TC_UNIQUE_SA_PER_MAP_ID_FALSE,
                            TC_CHECK_FECF_TRUE, 0x3F, SA_INCREMENT_NONTRANSMITTED_IV_FALSE);
    Crypto_Config_MariaDB("client-demo-kmc.example.com", "sadb", 3306, CRYPTO_TRUE, CRYPTO_TRUE,
                          "/home/itc/Desktop/CERTS/ammos-ca-bundle.crt", NULL,
                          "/home/itc/Desktop/CERTS/ammos-client-cert.pem",
                          "/home/itc/Desktop/CERTS/ammos-client-key.pem", NULL, "robert", NULL);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h = "202C047F0000020000000000000000000070E304CDF655C3FE953D03F0C9322A30FC1E9E93A753017B3B7890A0FF7DECFFE"
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_libg_100, "MDB+LIBG Process Security SHORT", num_frames_100,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, LSA_KMC_SHORT_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Process Security SHORT", num_frames_100,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, MDB_KMC_SHORT_100)
{
    Crypto_Config_CryptoLib(KEY_TYPE_KMC, MC_TYPE_INTERNAL, SA_TYPE_MARIADB, CRYPTOGRAPHY_TYPE_KMCCRYPTO, IV_INTERNAL,
                            CRYPTO_TC_CREATE_FECF_TRUE, TC_PROCESS_SDLS_PDUS_TRUE, TC_HAS_PUS_HDR,
                            TC_IGNORE_SA_STATE_FALSE, TC_IGNORE_ANTI_REPLAY_TRUE, TC_UNIQUE_SA_PER_MAP_ID_FALSE,
                            TC_CHECK_FECF_TRUE, 0x3F, SA_INCREMENT_NONTRANSMITTED_IV_FALSE);
    Crypto_Config_MariaDB("client-demo-kmc.example.com", "sadb", 3306, CRYPTO_TRUE, CRYPTO_TRUE,
                          "/home/itc/Desktop/CERTS/ammos-ca-bundle.crt", NULL,
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h = "202C047F0000020000000000000000000071B20E13F2B09519E820E696F04588AACE79E1827D42E5EA66F450E2C48936741"
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Process Security SHORT", num_frames_100,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, LSA_LIBG_MED_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C05FF00000A000000000000000000000063CC818D81B0A3B0B8CFAE6926856AB15F27C747E4F00F0314AC3174263FCC8ABEEE245A70"
        ...
        "69275339BC09F3349700E4214A275B9362EE08D2E1E6BBFE0D038007470DD17D8133451B027D1C73AA491256489F6FA2B1964BBA4A6746"
        "544ABF98C20C9511E5EFF08678A4B04BFBDFDF401D092FEF153DAB01DB3EBBF0C1879758A6485342DF30D84F46059846F2B910AC279437"
        "195F7B80DB14495CA46D9BC075A94CEE7F";
    int32_t status = Crypto_Init();
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n",
           (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security MED", num_frames_100,
                  0);
...
UTEST(PERFORMANCE, MDB_LIBG_MED_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C05FF000002000000000000000000007147C4888DE20936C8FFF8772894382BC0EADCFDA9B684BC64250309930E745CB9B300EA84D6"
        ...
        "8443E880A3BEB61C5A839BD702D6D35F7B783B3752D59A1D4A4909A677F88572B84665184AE5149E9492728DA5BBDEA36B6B27E2E6F819"
        "4136604C98497056815197F871B8C36B51";
    int32_t status = Crypto_Init();
    ...
    printf("\tMbps: %f\n",
           (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Process Security MED", num_frames_100,
                  0);
...
UTEST(PERFORMANCE, LSA_KMC_MED_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C05FF00000A000000000000000000000010B7D5264AA13C588EBCE851BB4CF923A94BDCB9E04ABB6688055EE94074AEFF78139C195E"
        ...
        "39E851EB324969EA367D98965AC0FA351B";
    int32_t status = Crypto_Init();
...
UTEST(PERFORMANCE, MDB_KMC_MED_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C05FF0000020000000000000000000071B8A9140EDCF90BEB2E84643FB928463D5E7CA5A2CA190B13DFCCBD7C150FC57FCAE7812FD9"
        ...
        "BD7D3121116AD14868BDA4EA305636D744";
    int32_t status = Crypto_Init();
...
UTEST(PERFORMANCE, LSA_LIBG_LONG_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C07FF00000A000000000000000000000063CC818D81B0A3B0B8CFAE6926856AB15F27C747E4F00F0314AC3174263FCC8ABEEE245A70"
        "5DF168E7AF81057111A8776502606B698CA119FFDAEE33FD3027358EC40BC2C166D6E5312BF6A813D97864A037D8E3696EFBF2052228DF"
        "90F3545628E3182AADD4E7084E423A4CCA88F7C0BAE07A50169E687A1D6232EA056F02AD1F8362D9168A239CDF20EA0615E2FF9B3FC9E0"
        "2852DD335F0ABCEBBC45A037E073A09B3300B3A2275A646209F4F5BF9C95A9D2A20881273A269B5DB614572D1E117CB73587832D3D63AC"
        "D4AD8C9C73AE9A0E521A8C85E19D20F9D670E709924849C46D578D91C0790EF998663E03DE0B830360B2C8E14DF8FA33BC0AC0120CCCA5"
        ...
        "26FF54DC43AA76B0EAF004973BCDD51265B306D68EF393E6389AE35858D1B619A3B7D6A3656C3F8EA9512FA6685A3F2710A5A6274FCA0B"
        "69275339BC09F3349700E4214A275B9362EE08D2E1E6BBFE0D038007470DD17D8133451B027D1C73AA491256489F6FA2B1964BBA4A6746"
        "544ABF98C20C9511E5EFF08678A4B04BFBDFDF401D092FEF153DAB01DB3EBBF0C1879758A6485342DF30D84F46059846F2B9100CEA4A31"
        "F68604E41C4448D56A4174B38CF4BA1B365904A442ABCAE1773DBD4007470E674DD5422C5F6DE74EBB068C1C0EEBB68378BB1CFFBC8893"
        ...
        "DF0BB5EE4E7B0FA14E0A56879A44D252BDA7939B777B6D283C85522F77202A574C0BA9049A3B9BBD059B2CE6CEAEE88B7C979FCB4333BB"
        "39AF5F14CFF8B8E8F477C15F11FC6A89365DD8CD258339AB6B748EAB34F93D007805E904A532E7BB5C90AE88209E6170A6656AFCBA6C9F"
        "6F5902A8117694C28BF9CF396648E993F5C59D5C60C5C175EEE70E2EA72EA67E2E6535E56E4F95B03B3B077572C6A021D1F1E54EA83DA8"
        "04E84CD4EE2368917D367552B102B80A5DA8203F65FA9C1BDB5992C0A75F9FF4B9052CD1A59D1AFFC4F31397702C795E36FD31DB437F23"
        "76F0E5C9D451777AF0BF88CFE466EE9F4BF2B7929689EDFB2A529ECF8DAFF177E382";
    int32_t status = Crypto_Init();
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n",
           (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security LONG", num_frames_100,
                  0);
...
UTEST(PERFORMANCE, MDB_LIBG_LONG_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C07FF000002000000000000000000007217E059763EF5ADFC613DFAC3D96B906BE1361B1652B72637738C5731EDEF6C0C8EF2A59151"
        ...
        "BE975F2EE94A4BE9225653EFE1D6B06CBD6B0987E74B15E348135C41A583A0B5F249B08615FBD9DADFF8C29C9ED9886501B39857A7E297"
        "1DE338BC25379CC1E525A1201DE30922C9E3975D7F7E7538FE3D08B9DDF34E7C9DAB5FC961747A4F6F2FAF5E1BEE8F1EBEC4403FE3F6AC"
        ...
        "2D4F3AF046C578A434DBFEA4B2CC9834633CF5919085126D95F74A444328113408AE6D798FF6961C38822D4523F9AA99C766AE3E5104BE"
        "7EE0E027C2F9B73BA07ADA882762FD93F590BF29FD0429BBC83DB4F531C1187B8DECEC0E5171027433358CE6E0AAAF50B59AC32EDE3D5B"
        ...
        "E4E751324B7E0AC2775996CDF33A46E09BCC24856D3112D844D337C57B9519F966A4";
    int32_t status = Crypto_Init();
    ...
    printf("\tMbps: %f\n",
           (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Process Security LONG", num_frames_100,
                  0);
...
UTEST(PERFORMANCE, LSA_KMC_LONG_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C07FF00000A0000000000000000000000042DD72659FA856512F4C35CA125B94FA62D41A46ECE953F746436776EDBB107E4CB804D02"
        "C0A794341D4D7D5A83C8735001B649FABAC5D32D62E64D3A7768CA60B79861A05434DAF398873705D0226717B99079451D42F01FCA9CC8"
        "95277B705096CA10A9873760CE387FCAB553B93D907F0C299B8427A514C09B36D9008DEFD8C38F7D9E2E7880430D08BFD76C98AE0A1E4A"
        "78A5D6E3651C81C418A20C1AA6871BD2C9170A411AB9C00376BC7019E867F7BA0D6A7C28A49E8462216D35C97DA05779F1DEE2A2C1C83E"
        ...
        "465F7C39A01FF125EADA21619420A89B7FC1706B7E2C6F21ECC923AE9E602FAAD137DBEA66B7CA8C536B00218DC58C398CA465F20DB154"
        "38E0D8A2D421AA56FFC7765B7B1903C20312103B86B96B2F8A2F8A72CEBC7D66F86FC2B1EC1662B602C72EEC1C2D6A0B6AF0DF1BC2AFE6"
        "35C2AB2C083F06D303FE3E45766C80499073177429C7A81EF3883A86FC4271D8F0C91EAB043DCF130CFC2AA1A48C3C20F1ABC1CE1E17B3"
        "E64DF5FE4996E285DEC0011A22DAAED5C58529B77E273A2389548748B780271D33A8BB8C380CE1C3CE8F3B2A487DD10D828F3146A2CE61"
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_lsa_kmc_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Process Security LONG", num_frames_100,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, MDB_KMC_LONG_100)
{
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x002C, 1, TC_HAS_FECF, TC_NO_SEGMENT_HDRS, 1024, AOS_FHEC_NA,
                                              AOS_IZ_NA, 0);
    char *data_h =
        "202C07FF00000200000000000000000000721BAC6AEED1D245278896BFCE8F455FC3DA3DFFFC84F3A42360697AC41AA8387B67F79EE9E3"
        ...
        "7A4D99669882357ECC0893E4D96A1E6E3D754CA24D5D997EDB91C647436A18A47377";
    int32_t status = Crypto_Init();
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100) / ttl_time_mdb_kmc_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Process Security LONG", num_frames_100,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, LSA_LIBG_SHORT_1K)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security SHORT", num_frames_1K,
                  0);
...
UTEST(PERFORMANCE, MDB_LIBG_SHORT_1K)
{
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_libg_100, "MDB+LIBG Process Security SHORT", num_frames_1K,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, LSA_KMC_SHORT_1K)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Process Security SHORT", num_frames_1K,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, MDB_KMC_SHORT_1K)
{
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Process Security SHORT", num_frames_1K,
                  0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
...
UTEST(PERFORMANCE, LSA_LIBG_MED_1K)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_1K) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security MED", num_frames_1K,
                  0);
...
UTEST(PERFORMANCE, MDB_LIBG_MED_1K)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_1K) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Process Security MED", num_frames_1K,
                  0);
...
UTEST(PERFORMANCE, LSA_LIBG_LONG_1K)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_1K) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Process Security LONG", num_frames_1K,
                  0);
...
UTEST(PERFORMANCE, MDB_LIBG_LONG_1K)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_1K) / ttl_time_lsa_libg_100) / 1024 / 1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Process Security LONG", num_frames_1K,
                  0);
