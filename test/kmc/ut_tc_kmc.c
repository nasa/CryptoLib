...
#define KMC_HOSTNAME           "localhost"
#define CA_PATH                "/home/jstar/Desktop/DCS/local-crypto/ammos-ca-bundle.crt"
#define CLIENT_CERTIFICATE     "/home/jstar/Desktop/DCS/local-crypto/mtls/ammos-client-leaf-cert.pem"
#define CLIENT_CERTIFICATE_KEY "/home/jstar/Desktop/DCS/local-crypto/mtls/ammos-client-key.pem"
...
void reload_db(void)
{
    ...
    system("mysql --host=localhost -u cryptosvc --skip-ssl-verify-server-cert "
           "--ssl-ca=/home/jstar/Desktop/DCS/local-crypto/ammos-ca-bundle.crt "
           "--ssl-cert=/home/jstar/Desktop/DCS/local-crypto/tls/ammos-server-leaf-cert.pem "
           "--ssl-key=/home/jstar/Desktop/DCS/local-crypto/tls/ammos-server-key.pem < "
...
#if defined(MYSQL_VERSION_ID) && !defined(MARIADB_BASE_VERSION)
...
UTEST(TC_APPLY_SECURITY, ENC_GCM_3X_THEN_DECRYPT)
{
    remove("sa_save_file.bin");
    int32_t return_val = CRYPTO_LIB_ERROR;
    reload_db();
    ...
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
    TCGvcidManagedParameters_t TC_UT_Managed_Parameters = {0, 0x0003, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_UT_Managed_Parameters);
    return_val = Crypto_Init();
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
    ...
    // 0x2003043300000003000000000000000000000003c755435350bb6ad6e5a80646150e2b986e71b6de323f3aadccd1c2ca4b65
...
//                             TC_IGNORE_SA_STATE_FALSE, TC_IGNORE_ANTI_REPLAY_TRUE, TC_IGNORE_SA_STATE_FALSE,
...
//     TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0); Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 1,
//     TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0); Crypto_Config_Add_Gvcid_Managed_Parameter(0,
//     0x0003, 2, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0);
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 3, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC,
//     AOS_NO_IZ, 0); int32_t return_val = Crypto_Init(); ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
...
//     "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE, CLIENT_CERTIFICATE, "PEM",
//     CLIENT_CERTIFICATE_KEY, NULL, NULL); Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 0, TC_HAS_FECF,
//     TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0); int32_t return_val = Crypto_Init();
//     ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
...
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 6, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC,
//     AOS_NO_IZ, 0); int32_t return_val = Crypto_Init(); ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
...
//     Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC,
//     AOS_NO_IZ, 0); int32_t return_val = Crypto_Init(); ASSERT_EQ(CRYPTO_LIB_SUCCESS, return_val);
...
//     "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE, CLIENT_CERTIFICATE, "PEM",
//     CLIENT_CERTIFICATE_KEY, NULL, NULL); Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 0, TC_HAS_FECF,
//     TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0); int32_t status = Crypto_Init();
...
//     "itc-kmc.nasa.gov", 8443, "crypto-service","/certs/ammos-ca-bundle.crt",NULL, CRYPTO_TRUE, CLIENT_CERTIFICATE,
//     "PEM", CLIENT_CERTIFICATE_KEY, NULL, NULL); Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0003, 6, TC_HAS_FECF,
//     TC_HAS_SEGMENT_HDRS, 1024, AOS_NO_FHEC, AOS_NO_IZ, 0);
