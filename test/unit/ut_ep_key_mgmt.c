...
UTEST(EP_KEY_MGMT, OTAR_0_140_142)
{
    ...
    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 157, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 157, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
...
UTEST(EP_KEY_MGMT, ACTIVATE_141_142)
{
    ...
    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 29, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 29, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
...
UTEST(EP_KEY_MGMT, DEACTIVATE_142)
{
    ...
    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 27, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
...
UTEST(EP_KEY_MGMT, VERIFY_132_134)
{
    ...
    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 61, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 61, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
...
UTEST(EP_KEY_MGMT, OTAR_0_140_142_MK_NOT_ACTIVE)
{
    ...
    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 159, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 159, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
...
UTEST(EP_KEY_MGMT, DEACTIVATE_142_NO_PUS)
{
    ...
    Crypto_Config_CryptoLib(KEY_TYPE_INTERNAL, MC_TYPE_INTERNAL, SA_TYPE_INMEMORY, CRYPTOGRAPHY_TYPE_LIBGCRYPT,
                            IV_INTERNAL);
    Crypto_Config_TC(CRYPTO_TC_CREATE_FECF_TRUE, TC_PROCESS_SDLS_PDUS_TRUE, TC_NO_PUS_HDR, TC_IGNORE_ANTI_REPLAY_TRUE, TC_IGNORE_SA_STATE_FALSE, 
                     TC_UNIQUE_SA_PER_MAP_ID_FALSE, TC_CHECK_FECF_FALSE, 0x3F, SA_INCREMENT_NONTRANSMITTED_IV_TRUE);

    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 23, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 23, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
    ...
    char *buffer_nist_key_h   = "000102030405060708090A0B0C0D0E0F000102030405060708090A0B0C0D0E0F";
    char *buffer_nist_iv_h    = "b6ac8e4963f49207ffd6374b"; // The last valid IV that was seen by the SA
    char *buffer_DEACTIVATE_h = "2003001600ff00001980d039000a030010008e1f6d21c4";
...
UTEST(EP_KEY_MGMT, TLV_KEY_DEACTIVATE_TESTS)
{
    ...
    TCGvcidManagedParameters_t TC_0_Managed_Parameters = {0, 0x0003, 0, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 1024, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_0_Managed_Parameters);

    TCGvcidManagedParameters_t TC_1_Managed_Parameters = {0, 0x0003, 1, TC_NO_FECF, TC_HAS_SEGMENT_HDRS, 1024, 1};
    Crypto_Config_Add_TC_Gvcid_Managed_Parameters(TC_1_Managed_Parameters);
