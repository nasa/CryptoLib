...
UTEST(CRYPTO_C, STRUCT_SIZE_VERIFICATION)
{
    ...
    ASSERT_EQ(TM_FRAME_SECHEADER_SIZE, (size_t)38);
    ASSERT_EQ(TM_FRAME_SECTRAILER_SIZE, (size_t)24);
    ASSERT_EQ(TM_SIZE, (size_t)(6 + 38 + 1786 + 24 + 2));
    ASSERT_EQ(AOS_FRAME_PRIMARYHEADER_SIZE, (size_t)8);
    ASSERT_EQ(AOS_FRAME_SECHEADER_SIZE, (size_t)70);
    ASSERT_EQ(AOS_FRAME_SECTRAILER_SIZE, (size_t)24);
    ASSERT_EQ(AOS_SIZE, (size_t)(8 + 70 + 1786 + 24 + 2));
}
