...
UTEST(CRYPTO_CONFIG, CRYPTO_INIT_MARIADB_NULL)
{
    ...
    TCGvcidManagedParameters_t gvcid_managed_paramenters_p = {0, 0, 0, 0,
                                                              0, 0, 1}; // = malloc(sizeof(GvcidManagedParameters_t));
...
//    CRYPTOGRAPHY_TYPE_UNINITIALIZED,
//                            IV_INTERNAL, CRYPTO_TC_CREATE_FECF_TRUE, TC_PROCESS_SDLS_PDUS_TRUE,
//                            TC_HAS_PUS_HDR, TC_IGNORE_SA_STATE_FALSE, TC_IGNORE_ANTI_REPLAY_FALSE, TC_IGNORE_SA_STATE_FALSE, 
