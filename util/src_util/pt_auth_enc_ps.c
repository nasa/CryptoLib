...
UTEST(PERFORMANCE, LSA_LIBG_SHORT_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Apply Security SHORT", num_frames_100, 1);
...
UTEST(PERFORMANCE, MDB_LIBG_SHORT_100)
{
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_libg_100, "MDB+LIBG Apply Security SHORT", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
}
...
UTEST(PERFORMANCE, LSA_KMC_SHORT_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Apply Security SHORT", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
...
UTEST(PERFORMANCE, MDB_KMC_SHORT_100)
{
    ...
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Apply Security SHORT", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
}
...
UTEST(PERFORMANCE, LSA_LIBG_MED_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_libg_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Apply Security MED", num_frames_100, 0);
...
UTEST(PERFORMANCE, MDB_LIBG_MED_100)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_libg_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Apply Security MED", num_frames_100, 0);
...
UTEST(PERFORMANCE, LSA_KMC_MED_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_kmc_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Apply Security MED", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
...
UTEST(PERFORMANCE, MDB_KMC_MED_100)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_mdb_kmc_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Apply Security MED", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
}
...
UTEST(PERFORMANCE, LSA_LIBG_LONG_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_libg_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "LSA+LIBG Apply Security LONG", num_frames_100, 0);
...
UTEST(PERFORMANCE, MDB_LIBG_LONG_100)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_libg_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_libg_100, "MDB+LIBG Apply Security LONG", num_frames_100, 0);
...
UTEST(PERFORMANCE, LSA_KMC_LONG_100)
{
    ...
    *test_association->ecs = CRYPTO_CIPHER_AES256_GCM;
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_lsa_kmc_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_lsa_kmc_100, "LSA+KMC Apply Security LONG", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    free(processed_frame);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
...
UTEST(PERFORMANCE, MDB_KMC_LONG_100)
{
    ...
    printf("\tMbps: %f\n", (((processed_frame->tc_pdu_len * 8 * num_frames_100)/ttl_time_mdb_kmc_100)/1024/1024));
    printf("\n");
    Write_To_File(processed_frame->tc_pdu_len, ttl_time_mdb_kmc_100, "MDB+KMC Apply Security LONG", num_frames_100, 0);
    Crypto_Shutdown();
    free(data_b);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
}
